 ...
 * @apiError (401) {NotAuthorized} NotAuthorized There is no account that uses those credentials.
 */
 ...
 *
 * @apiError (400) {BadRequest} Invalid_request_parameters Error returned if the type URL param was not correct.
 * @apiError (401) {NotAuthorized} NotAuthorized There is no account that uses those credentials.
 */
api.getUserTasks = {
  method: 'GET',
